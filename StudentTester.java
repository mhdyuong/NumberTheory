...
{
   public void testPF_MichelleIsA()
   {
      NumberTheoryProblems nt = new NumberTheoryProblems();

      assertEquals("1110000101010111100110111101111", nt.hexadecimalToBinary("70ABCDEF"));
      assertEquals("110111001011101010010000", nt.hexadecimalToBinary("DCBA90"));
      assertEquals("1110110111001011101010010000", nt.hexadecimalToBinary("EDCBA90"));
      assertEquals("11111110110111001011101010010000", nt.hexadecimalToBinary("FEDCBA90"));
      assertEquals("1011111110110111001011101010010000", nt.hexadecimalToBinary("2FEDCBA90"));
   }
